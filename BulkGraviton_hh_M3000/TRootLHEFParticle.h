...
// Thu Aug 16 21:04:29 2018 by ROOT version 6.12/06
// from TTree LHEF/Analysis tree
// found on file: BulkGraviton_hh_M3000_cmsgrid_final.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("BulkGraviton_hh_M3000_cmsgrid_final.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("BulkGraviton_hh_M3000_cmsgrid_final.root");
      }
